        ...
        <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-8 relative overflow-hidden">
          ...
          {result ? (
              <div className="text-center py-8 opacity-50">
                  ...
                  <p className="text-sm text-gray-600 mt-2">Ответы больше не принимаются.</p>
              </div>
          ) : !canSolve ? (
              <div className="text-center py-12 bg-red-900/10 rounded border border-red-500/20">
                  <h3 className="text-xl font-bold text-red-400 mb-2">🚫 Доступ закрыт</h3>
                  <p className="text-gray-400">Вы использовали все попытки или уже получили максимальный балл.</p>
              </div>
          ) : (
