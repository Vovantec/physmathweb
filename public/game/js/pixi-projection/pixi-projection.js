...
/*!
 * pixi-projection - v0.4.1
 * Compiled Tue, 27 Jul 2021 22:47:12 UTC
 *
...
class Projection2d extends LinearProjection
{
    ...
    {
        super(legacy, enable);Projection2d.prototype.__init.call(this);Projection2d.prototype.__init2.call(this);Projection2d.prototype.__init3.call(this);        this.local = new Matrix2d();
...
gl_FragColor = texture2D(uSampler, vTextureCoord) * uColor;
    ...
    {
        super(geometry, shader, state, drawMode);Mesh2d.prototype.__init.call(this);        this.proj = new Projection2d(this.transform);
    }
...
class Sprite2d extends sprite.Sprite
{
    constructor(texture)
    {
        super(texture);Sprite2d.prototype.__init.call(this);        this.proj = new Projection2d(this.transform);
...
class Text2d extends text.Text
{
    ...
    {
        super(text, style, canvas);Text2d.prototype.__init.call(this);        this.proj = new Projection2d(this.transform);
        this.pluginName = 'batch2d';
    }
...
class Projection3d extends LinearProjection
{
    constructor(legacy, enable)
    {
        super(legacy, enable);Projection3d.prototype.__init.call(this);Projection3d.prototype.__init2.call(this);Projection3d.prototype.__init3.call(this);Projection3d.prototype.__init4.call(this);Projection3d.prototype.__init5.call(this);Projection3d.prototype.__init6.call(this);        this.local = new Matrix3d();
...
class Camera3d extends Container3d
{
    constructor()
    {
        super();Camera3d.prototype.__init.call(this);Camera3d.prototype.__init2.call(this);Camera3d.prototype.__init3.call(this);Camera3d.prototype.__init4.call(this);        this.proj.cameraMode = true;
...
class Mesh3d2d extends mesh.Mesh
{
    constructor(geometry, shader, state, drawMode)
    {
        super(geometry, shader, state, drawMode);Mesh3d2d.prototype.__init.call(this);        this.proj = new Projection3d(this.transform);
    }
...
class Sprite3d extends sprite.Sprite
{
    constructor(texture)
    {
        super(texture);Sprite3d.prototype.__init.call(this);Sprite3d.prototype.__init2.call(this);Sprite3d.prototype.__init3.call(this);        this.proj = new Projection3d(this.transform);
        this.pluginName = 'batch2d';
    }
...
class Text3d extends text.Text
{
    constructor(text, style, canvas)
    {
        super(text, style, canvas);Text3d.prototype.__init.call(this);        this.proj = new Projection3d(this.transform);
        this.pluginName = 'batch2d';
    }
...
class Sprite2s extends sprite.Sprite
{
    constructor(texture)
    {
        super(texture);Sprite2s.prototype.__init.call(this);        this.proj = new ProjectionSurface(this.transform);
...
class Text2s extends text.Text
{
    constructor(text, style, canvas)
    {
        super(text, style, canvas);Text2s.prototype.__init.call(this);        this.proj = new ProjectionSurface(this.transform);
        this.pluginName = 'batch_bilinear';
    }
